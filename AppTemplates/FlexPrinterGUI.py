...
def FlexPrinterGUI(apparatus, materials, tools):
    ...
    devices = {}
    devices['gantry'] = {
        'type': 'Aerotech_A3200_FlexPrinter',
        'model': 'Flex Printer',
        'descriptors': ['motion'],
        'addresstype': 'zmqNode',
        'address': 'procexec',
    ...
    apparatus['information']['alignments']['initial'] = {
        'X': '',
        'Y': '',
        'ZZ1': '',
        'ZZ2': '',
    ...
    for materialx in materials:
        ...
        devices['n' + material + 'slide'] = {
            'ID': '',
            'OD': '',
            'type': '',
            'addresstype': '',
            'descriptors': ['nozzle', material + 'slide'],
        }
        ...
        devices['gantry']['n' + material + 'slide']['axismask'] = devices['gantry'][
            'n' + material
        ]['axismask']
        ...
        apparatus['information']['alignments']['n' + material + '@mark'] = {
            'X': '',
            'Y': '',
            zaxis: '',
        }
        ...
        if primenozzle:
            ...
            apparatus['information']['alignments']['n' + material + '@start'] = {
                'X': '',
                'Y': '',
                zaxis: '',
            }
            apparatus['information']['alignmentnames'].append('n' + material + '@cal')
            apparatus['information']['alignments']['n' + material + '@cal'] = {
                'X': '',
                'Y': '',
                zaxis: '',
            }
    ...
    for tool in tools:
        ...
        if tool['type'] == 'Keyence_GT2_A3200':
            ...
            apparatus['information']['alignments'][tool['name'] + '@TP_init'] = {
                'X': -200,
                'Y': -250,
                'ZZ2': -50,
            }
