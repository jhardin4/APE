...
class SpanningSample(Procedure):
    def Prepare(self):
        ...
        self.requirements['trayaddress'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'name of the sample tray',
        }
        ...
        self.apparatus.createAppEntry(
            ['information', 'ProcedureData', 'SpanningSample', 'cur_parameters', 'yGap']
        )
        self.apparatus.createAppEntry(
    ...
    def Plan(self):
        ...
        oalignments = self.apparatus.getValue(
        ...
        self.iImages.Do(
            {'samplename': samplename, 'zOffset': 0.5, 'nozzlename': nozzlename}
        )
        self.TPgen.Do()
        self.TPprint.requirements['toolpath']['address'] = [
            'information',
            'toolpaths',
            'toolpath',
        ]
        ...
        for alignment in alignments:
            if '@start' in alignment:
                ...
                self.apparatus.setValue(
                    ['information', 'alignments', alignment], oalignment
                )
