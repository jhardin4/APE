...
class Suggest(Core.Procedure):
    ...
    def Plan(self):
        ...
        self.recordData.requirements['value']['address'] = [
            'information',
            'ProcedureData',
            'SpanningSample',
            'cur_parameters',
        ...
        good_streak = (
            0
        )  # use good_streak as a double check.. this counts number of goods we have had in a row
        double_check_lim = (
            3
        )  # this is the number of times it will double check after reciving a good
        ...
        while good_streak < double_check_lim:
            ...
            if prevSpeed == {}:
                ...
                if prvClass == '1':
                    ...
                    if good_streak == double_check_lim:
                        ...
                        print(
                            'Good Detected... Repeat Speed: ' + str(nxtSpeed) + ' mm/s'
                        )
                    pass
                elif prvClass == '2':
                    ...
                    self.apparatus.setValue(
                        ['devices', motionname, nozzlename, 'speed'], nxtSpeed
                    )
                elif prvClass == '3':
            ...
            self.newsample.Do(
                {
                    'trayaddress': trayaddress,
                    'material': material,
                    'yGap': yGap,
                    'zGap': zGap,
                }
            )
            ifilename = self.apparatus.getValue(
                [
                    'information',
                    'ProcedureData',
                    'SpanningSample',
            ...
            ffilename = self.apparatus.getValue(
                [
                    'information',
                    'ProcedureData',
                    'SpanningSample',
