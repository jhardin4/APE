...
from UI import deconvolver as gcodecmd
...
def GenerateToolpath(data, target):
    ...
    pointlist = gcodecmd.getape ( 'auto' ).run( )
    
    #{ startpoint, endpoint, material, speed }
    
    toolpath3D =  tpt.nPt2ToolPath (pointlist, materialname) 
