...
class ChangeMat(Procedure):
    def Prepare(self):
        self.name = 'ChangeMat'
        self.requirements['startmotion'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'motion before change',
        }
        self.requirements['endmotion'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'motion afterchange',
        }
    ...
    def Plan(self):
        ...
        if startmotion['material'] == endmotion['material'].replace(
            'slide', ''
        ) or endmotion['material'] == startmotion['material'].replace('slide', ''):
