...
class Motion_RefRelPriorityLineMotion(Procedure):
    def Prepare(self):
        ...
        self.requirements['relpoint'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'Reference point',
        }
        self.requirements['refpoint'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'Point relative to reference position',
        }
        self.requirements['speed'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'Target speed, typicalling in mm/s',
        }
        self.requirements['axismask'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'Dictionary of motion settings',
        }
        self.requirements['priority'] = {
            'source': 'apparatus',
            'address': '',
            'value': '',
            'desc': 'order of operations for moving to a point',
        }
