...
class Aerotech_A3200_getPosition(Procedure):
    def Prepare(self):
        ...
        self.requirements['axisList'] = {'source': 'apparatus', 'address': '', 'value': '', 'desc': 'Axes to get the position of'}
        self.requirements['target'] = {'source': 'apparatus', 'address': '', 'value': '', 'desc': 'AppAddress where the result is stored'}
        self.requirements['target']['value'] = ['information','procedures','Aerotech_A3200_getPosition', 'result']
